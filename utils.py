from crawler_np_104 import crawl_thread,crawl_url,crawl_content,setting
import numpy as np
...
def main(job_keyword,max_pages,area):
    area_code = setting(area)
    # 建立 NumPy 陣列
    data_np = np.array([['company', 'job_name', 'job_area', 'job_salary', 'job_content', 'job_exp', 'job_require_major', 'job_welfare', 'job_contact', 'URL']])
